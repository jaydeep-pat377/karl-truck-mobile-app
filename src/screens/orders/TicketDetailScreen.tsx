          ...
          return (
            <View style={styles.etaSection} pointerEvents={etaLoading ? 'none' : 'auto'}>
              <TouchableOpacity
                ...
                <Text style={[styles.etaHeaderTitle, { color: isDark ? '#FED7AA' : '#7C2D12' }]}>{t('orders.eta')}</Text>
                {hasEta && (
          ...
          <View style={styles.qrModalContent}>
            ...
            >
              ...
              <View style={styles.qrHeaderRow1}>
                ...
                <View style={{ flex: 1 }}>
                  <AppText style={styles.qrHeaderTitle}>{t('orders.ticketQrCode')}</AppText>
                  <AppText style={styles.qrHeaderSubtitle}>{t('orders.scanToViewTicket')}</AppText>
                </View>
              </View>

              {/* Row 2: Ticket Number */}
              <View style={styles.qrHeaderTicketRow}>
                <AppText style={styles.qrHeaderTicketLabel}>{t('orders.ticketNumber')}</AppText>
              ...
              <View style={styles.qrHeaderStatusRow}>
                <View style={[styles.qrStatusPill, { backgroundColor: 'rgba(255,255,255,0.95)' }]}>
                  ...
                  <AppText style={[styles.qrStatusText, { color: getQrStatusColor(currentStatusDisplayText || '') }]}>
                    {currentStatusDisplayText || t('tracking.statuses.pending')}
                  </AppText>
                </View>
                <View style={styles.qrLivePill}>
                  <View style={styles.qrLiveDot} />
                  <AppText style={styles.qrLiveText}>{t('orders.live')}</AppText>
                </View>
              </View>
            </LinearGradient>
