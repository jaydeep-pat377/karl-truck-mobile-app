    ...
    return (
      <View style={[styles.container, { backgroundColor: themeColors.background }]}>
        ...
        <View style={styles.loadingContainer}>
          <TruckLoader
            size={120}
            message={t('orders.product.loadingProductDetails')}
      ...
      <View style={[styles.container, { backgroundColor: themeColors.background }]}>
        ...
        <View style={styles.errorContainer}>
          ...
          <Text style={[styles.errorText, { color: themeColors.text.primary }]}>
            {error || t('orders.product.failedToLoad')}
          </Text>
          <TouchableOpacity
            ...
            {jobData.weatherData && (
              <TouchableOpacity
                ...
                <Text style={[styles.weatherDescText, { color: themeColors.text.secondary }]} numberOfLines={1}>
                  {jobData.weatherData.weather_description || t('orders.product.partlyCloudy')}
                </Text>
                ...
                {jobData.weatherData.wind_speed_mph !== null && jobData.weatherData.wind_speed_mph !== undefined && (
                  <>
                    <View style={[styles.weatherDot, { backgroundColor: themeColors.text.hint }]} />
                    <Text style={[styles.weatherValueText, { color: themeColors.text.secondary }]}>
                      {t('orders.product.mphWind', { value: jobData.weatherData.wind_speed_mph })}
                    </Text>
                  </>
                )}
                {jobData.weatherData.humidity !== null && jobData.weatherData.humidity !== undefined && (
                  <>
                    <View style={[styles.weatherDot, { backgroundColor: themeColors.text.hint }]} />
                    <Text style={[styles.weatherValueText, { color: themeColors.text.secondary }]}>
                      {t('orders.product.humidityRh', { value: jobData.weatherData.humidity })}
                    </Text>
                  </>
                )}
          ...
          <View style={styles.cardHeader}>
            <View style={styles.cardTitleRow}>
              ...
              <Text style={[styles.cardTitle, { color: themeColors.text.primary }]}>
                {t('orders.product.orderOverview')}
              </Text>
            </View>
          ...
          <View style={styles.infoGrid}>
            <View style={[styles.infoItem, { backgroundColor: isDark ? themeColors.surface : colors.grey[3] }]}>
              <View style={styles.infoItemHeader}>
                ...
                <Text style={[styles.infoItemLabel, { color: themeColors.text.hint }]}>{t('orders.product.startTime')}</Text>
              </View>
            ...
            <View style={[styles.infoItem, { backgroundColor: isDark ? themeColors.surface : colors.grey[3] }]}>
              <View style={styles.infoItemHeader}>
                ...
                <Text style={[styles.infoItemLabel, { color: themeColors.text.hint }]}>{t('orders.product.product')}</Text>
              </View>
              <Text style={[styles.infoItemValue, { color: themeColors.text.primary }]} numberOfLines={1}>
                {jobData.productType}
              </Text>
              ...
              {jobData.orderedVolume > 0 && (
                <View style={styles.productSlumpRow}>
                  ...
                  <Text style={[styles.productInfoBadgeText, { color: colors.primary.main }]}>
                    {t('orders.product.orderQty', { value: jobData.orderedVolume })}
                  </Text>
                </View>
              )}
              {jobData.slump && (
                <View style={styles.productSlumpRow}>
                  ...
                  <Text style={[styles.productInfoBadgeText, { color: colors.info.main }]}>
                    {t('orders.product.slumpInch', { value: jobData.slump })}
                  </Text>
                </View>
              )}
            </View>
            ...
            <View style={[styles.infoGrid, { marginTop: GRID.xs }]}>
              <View style={[styles.infoItem, { backgroundColor: isDark ? themeColors.surface : colors.grey[3] }]}>
                <View style={styles.infoItemHeader}>
                  ...
                  <Text style={[styles.infoItemLabel, { color: themeColors.text.hint }]}>{t('orders.product.deliveredQty')}</Text>
                </View>
                <Text style={[styles.infoItemValue, { color: colors.success.main }]}>
                  {formatQty(jobData.scheduledDelvQty ?? 0)} CY
                </Text>
                <Text style={[styles.infoItemSubValue, { color: themeColors.text.secondary }]}>
                  {t('orders.product.pouredPercent', { value: jobData.pouredPercent })}
                </Text>
              </View>
              ...
              <View style={[styles.infoItem, { backgroundColor: isDark ? themeColors.surface : colors.grey[3] }]}>
                <View style={styles.infoItemHeader}>
                  ...
                  <Text style={[styles.infoItemLabel, { color: themeColors.text.hint }]}>{t('orders.product.loads')}</Text>
                </View>
          ...
          {(jobData.spacingMinutes > 0 || jobData.scheduledRate > 0 || jobData.actualSpacingMinutes > 0) && (
            <View style={[styles.timingRow, { backgroundColor: isDark ? themeColors.surface : colors.grey[3], marginTop: GRID.xs, marginHorizontal: GRID.md }]}>
              <View style={styles.timingItem}>
                ...
                <Text style={[styles.timingLabel, { color: themeColors.text.hint }]}>{t('orders.product.spacing')}</Text>
                <Text style={[styles.timingValue, { color: themeColors.text.primary }]}>
                  {jobData.spacingMinutes > 0 ? `${jobData.spacingMinutes} ${t('orders.product.min')}` : '-'}
                </Text>
              </View>
              ...
              <View style={styles.timingItem}>
                ...
                <Text style={[styles.timingLabel, { color: themeColors.text.hint }]}>{t('orders.product.schedRate')}</Text>
                <Text style={[styles.timingValue, { color: themeColors.text.primary }]}>
              ...
              <View style={styles.timingItem}>
                ...
                <Text style={[styles.timingLabel, { color: themeColors.text.hint }]}>{t('orders.product.actual')}</Text>
                <Text style={[styles.timingValue, { color: themeColors.text.primary }]}>
          ...
          {hasAverages && (
            <View style={[styles.averagesRow, { backgroundColor: isDark ? themeColors.surface : colors.grey[3], marginTop: GRID.xs, marginHorizontal: GRID.md }]}>
              <View style={styles.averageItem}>
                ...
                <Text style={[styles.averageLabel, { color: themeColors.text.hint }]}>{t('orders.product.wait')}</Text>
              ...
              <View style={styles.averageItem}>
                ...
                <Text style={[styles.averageLabel, { color: themeColors.text.hint }]}>{t('orders.product.pour')}</Text>
                <Text style={[styles.averageValue, { color: themeColors.text.primary }]}>
              ...
              <View style={styles.averageItem}>
                ...
                <Text style={[styles.averageLabel, { color: themeColors.text.hint }]}>{t('orders.product.wash')}</Text>
                <Text style={[styles.averageValue, { color: themeColors.text.primary }]}>
            ...
            <View style={[
                    ...
                    >
                      ...
                      <View style={styles.productListHeader}>
                        <View style={styles.productTypeLabelRow}>
                          ...
                          <Text style={[
                            ...
                            {item.isPrimary ? t('orders.product.concrete') : t('orders.product.associated')}
                          </Text>
                        </View>
                      ...
                      <View style={styles.productListDetailsGrid}>
                        ...
                        <View style={styles.productListDetailItem}>
                          <Text style={[styles.productListDetailLabel, { color: themeColors.text.hint }]}>{t('orders.product.qty')}</Text>
                        ...
                        {item.isPrimary && (
                          <View style={styles.productListDetailItem}>
                            <Text style={[styles.productListDetailLabel, { color: themeColors.text.hint }]}>{t('orders.product.slump')}</Text>
              ...
              <View style={[styles.skuCardHeader, { borderTopWidth: 1, borderTopColor: isDark ? themeColors.border : colors.grey[10] }]}>
                <View style={styles.cardTitleRow}>
                  ...
                  <Text style={[styles.cardTitle, { color: themeColors.text.primary }]}>
                    {t('orders.product.deliverySchedule')}
                  </Text>
                </View>
              </View>
                ...
                <View style={[styles.skuScheduleSection, { borderTopColor: isDark ? themeColors.border : colors.grey[10] }]}>
                  ...
                  <View style={styles.skuScheduleRow}>
                    <View style={[styles.skuScheduleItem, { backgroundColor: isDark ? themeColors.cardElevated : colors.grey[3] }]}>
                      ...
                      <Text style={[styles.skuScheduleItemLabel, { color: themeColors.text.secondary }]}>{t('orders.product.loads')}</Text>
                    </View>
                    ...
                    <View style={[styles.skuScheduleItem, { backgroundColor: isDark ? themeColors.cardElevated : colors.grey[3] }]}>
                      ...
                      <Text style={[styles.skuScheduleItemLabel, { color: themeColors.text.secondary }]}>{t('orders.product.loadCy')}</Text>
                    </View>
                    ...
                    <View style={[styles.skuScheduleItem, { backgroundColor: isDark ? themeColors.cardElevated : colors.grey[3] }]}>
                      ...
                      <Text style={[styles.skuScheduleItemLabel, { color: themeColors.text.secondary }]}>{t('orders.product.cyHr')}</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.skuScheduleRow}>
                    <View style={[styles.skuScheduleItem, { backgroundColor: isDark ? themeColors.cardElevated : colors.grey[3] }]}>
                      ...
                      <Text style={[styles.skuScheduleItemLabel, { color: themeColors.text.secondary }]}>{t('orders.product.spacing')}</Text>
                    </View>
                    ...
                    <View style={[styles.skuScheduleItem, { backgroundColor: isDark ? themeColors.cardElevated : colors.grey[3] }]}>
                      ...
                      <Text style={[styles.skuScheduleItemLabel, { color: themeColors.text.secondary }]}>{t('orders.product.miles')}</Text>
                    </View>
                    ...
                    <View style={[styles.skuScheduleItem, { backgroundColor: isDark ? themeColors.cardElevated : colors.grey[3] }]}>
                      ...
                      <Text style={[styles.skuScheduleItemLabel, { color: themeColors.text.secondary }]}>{t('orders.product.toJob')}</Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.skuScheduleRow}>
                    <View style={[styles.skuScheduleItem, { backgroundColor: isDark ? themeColors.cardElevated : colors.grey[3] }]}>
                      ...
                      <Text style={[styles.skuScheduleItemLabel, { color: themeColors.text.secondary }]}>{t('orders.product.unload')}</Text>
                    </View>
                    ...
                    <View style={[styles.skuScheduleItem, { backgroundColor: isDark ? themeColors.cardElevated : colors.grey[3] }]}>
                      ...
                      <Text style={[styles.skuScheduleItemLabel, { color: themeColors.text.secondary }]}>{t('orders.product.wash')}</Text>
                    </View>
                    ...
                    <View style={[styles.skuScheduleItem, { backgroundColor: isDark ? themeColors.cardElevated : colors.grey[3] }]}>
                      ...
                      <Text style={[styles.skuScheduleItemLabel, { color: themeColors.text.secondary }]}>{t('orders.product.toPlant')}</Text>
                    </View>
                  </View>
                </View>
              )}
                ...
                <View style={[styles.productListItem, { backgroundColor: isDark ? themeColors.cardElevated : colors.grey[3], borderColor: isDark ? themeColors.border : colors.grey[10] }]}>
                  <View style={styles.contactInfoRow}>
                    ...
                    <View style={styles.contactInfoContent}>
                      <Text style={[styles.contactInfoLabel, { color: themeColors.text.hint }]}>{t('orders.product.plantName')}</Text>
                      ...
                      {jobData.plantCode ? (
                        <Text style={[styles.contactInfoSubValue, { color: themeColors.text.secondary }]}>
                          {t('orders.product.codeLabel', { code: jobData.plantCode })}
                        </Text>
                      ) : null}
                    </View>
                  </View>
                  ...
                  {(jobData.plantAddress1 || jobData.plantAddress2) && (
                    <View style={[styles.contactInfoRow, { marginTop: GRID.sm }]}>
                      ...
                      <View style={styles.contactInfoContent}>
                        <Text style={[styles.contactInfoLabel, { color: themeColors.text.hint }]}>{t('orders.product.address')}</Text>
                  ...
                  {jobData.plantPhone && (
                    <View style={[styles.contactInfoRow, { marginTop: GRID.sm }]}>
                      ...
                      <View style={styles.contactInfoContent}>
                        <Text style={[styles.contactInfoLabel, { color: themeColors.text.hint }]}>{t('orders.product.phone')}</Text>
                    ...
                    <View style={styles.skuLoadsHeaderLeft}>
                      ...
                      <View style={styles.skuLoadsTextContainer}>
                        <Text style={[styles.skuLoadsTitle, { color: themeColors.text.primary }]}>
                          {t('orders.product.scheduledLoads')}
                        </Text>
                        <Text style={[styles.skuLoadsSubtitle, { color: themeColors.text.secondary }]}>
                          {t('orders.product.loadsCompleted', { completed: jobData.scheduledLoadsSummary.completedCount, total: jobData.scheduledLoadsSummary.total })}
                        </Text>
                      </View>
                    </View>
