...
export const OrderTrackingScreen: React.FC = () => {
            ...
            <View style={styles.statusTimeContainer}>
              ...
              <View style={[styles.statusChip, { backgroundColor: `${config.color}15` }]}>
                ...
                <Text style={[styles.statusChipText, { color: config.color }]} numberOfLines={1}>
                  {ticket.status?.toLowerCase().includes('cancel') || ticket.status_display?.toLowerCase().includes('cancel') ? t('tracking.voided') : (ticket.status_display || config.label)}
                </Text>
              </View>
            </View>
          </View>
            ...
            {ticket.timestamps?.eta_at_job && ['loading', 'loaded', 'to_job'].includes(ticket.status) && (
              <View style={[styles.etaChip, { backgroundColor: isDark ? `${colors.common.white}15` : `${colors.common.black}10` }]}>
                ...
                <Text style={[styles.etaText, { color: isDark ? colors.common.white : colors.common.black }]} numberOfLines={1}>
                  {t('tracking.etaPrefix', { time: ticket.timestamps.eta_at_job })}
                </Text>
              </View>
            )}
    ...
    return (
      <SafeAreaView style={[styles.container, { backgroundColor: themeColors.background }]}>
        ...
        <View style={styles.loadingWrap}>
          <TruckLoader size={80} message={t('tracking.loadingTracking')} color={isDark ? 'light' : 'dark'} />
        </View>
      </SafeAreaView>
    );
  }
  ...
  return (
    <View style={[styles.container, { backgroundColor: themeColors.background }]}>
      ...
      <Animated.View style={[styles.mapWrap, { height: mapHeight }]}>
                ...
                <View style={styles.markerLabelContainer}>
                  <View style={[styles.markerLabel, { backgroundColor: colors.warning.main }]}>
                    ...
                    <Text style={styles.markerLabelText} numberOfLines={1}>
                      {trackingData?.plant?.description || t('tracking.plant')}
                    </Text>
                  </View>
                </View>
        ...
        {!isMapReady && (
          <View style={styles.mapLoadingOverlay}>
            ...
            <Text style={styles.mapLoadingText}>{t('tracking.loadingMap')}</Text>
          </View>
        )}
      ...
      {isMapReady && (() => {
          const legendItems = [
            ['ticketed', t('tracking.statusLabel.ticketed'),  'loading',  t('tracking.statusLabel.loading')],
            ['to_job',   t('tracking.statusLabel.toJob'),    'at_job',   t('tracking.statusLabel.atJob')],
            ['pouring',  t('tracking.statusLabel.pour'),      'washing',  t('tracking.statusLabel.wash')],
            ['to_plant', t('tracking.statusLabel.toPlant'),  'at_plant', t('tracking.statusLabel.atPlant')],
          ];
          return (
            <Animated.View
              style={{
            ...
            >
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: ms(4) }}>
                  ...
                  <Text style={{ fontSize: ms(10), fontFamily: fontFamily.bold, color: themeColors.text.primary }}>{t('tracking.status')}</Text>
        ...
        <View style={[styles.orderInfoCard, { backgroundColor: themeColors.card }]}>
          <View style={styles.orderInfoHeader}>
            ...
            <View style={styles.liveBadgeSmall}>
              ...
              <Text style={styles.liveTextSmall}>{t('tracking.live')}</Text>
            </View>
          </View>
          ...
          <View style={styles.progressTop}>
            <View style={styles.progressStats}>
              <View style={styles.progressStat}>
                <Text style={[styles.statLabel, { color: themeColors.text.hint }]}>{t('tracking.ordered')}</Text>
              ...
              <View style={styles.progressStat}>
                <Text style={[styles.statLabel, { color: themeColors.text.hint }]}>{t('tracking.delivered')}</Text>
              ...
              <View style={[styles.statDivider, { backgroundColor: themeColors.border }]} />
              <View style={styles.progressStat}>
                <Text style={[styles.statLabel, { color: themeColors.text.hint }]}>{t('tracking.remaining')}</Text>
