    ...
    return (
      <SafeAreaView style={st.container} edges={['top', 'bottom']}>
        ...
        <Animated.ScrollView style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }} contentContainerStyle={st.content} showsVerticalScrollIndicator={false}>
          ...
          {isTruck && (
            <View style={st.card}>
              <Row label={t('scanDetails.truck')} value={apiTruck?.code || tkData.truckCode} />
              {apiTruck?.description && (<><Div /><Row label={t('scanDetails.description')} value={apiTruck.description} /></>)}
              {apiTruck?.current_driver_name && (<><Div /><Row label={t('scanDetails.driver')} value={apiTruck.current_driver_name} /></>)}
              {apiTruck?.ticket_status && (<><Div /><Row label={t('scanDetails.status')} value={apiTruck.ticket_status} /></>)}
              {apiTruck?.order_code && (<><Div /><Row label={t('scanDetails.currentOrder')} value={apiTruck.order_code} /></>)}
              {apiTruck?.customer_name && (<><Div /><Row label={t('scanDetails.customer')} value={apiTruck.customer_name} /></>)}
              {apiTruck?.delivery_address && (<><Div /><Row label={t('scanDetails.delivery')} value={apiTruck.delivery_address} /></>)}
              {apiTruck?.plant_name && (<><Div /><Row label={t('scanDetails.plant')} value={apiTruck.plant_name} /></>)}
              <Div /><Row label={t('scanDetails.issuedAt')} value={formatIat(tkData.iat)} />
            </View>
          )}
