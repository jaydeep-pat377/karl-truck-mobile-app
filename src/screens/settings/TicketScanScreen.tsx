      ...
      try {
        ...
        if (isTK || isPipe) {
          ...
          if (result.status === 'unauthorized') {
            showErrorSheet(t('ticketScan.errors.notAuthorizedTitle'), result.message || t('ticketScan.errors.notAuthorizedMessage'), 'lock-outline', false);
          ...
          if (result.status === 'not_found') {
            showErrorSheet(t('ticketScan.errors.ticketNotFoundTitle'), result.message || t('ticketScan.errors.ticketNotFoundMessage'), 'magnify');
            return;
          }

          if (result.status === 'error') {
            showErrorSheet(t('ticketScan.errors.unableToScanTitle'), result.message || t('ticketScan.errors.verificationFailed'), 'alert-circle-outline');
            return;
          }

          if (result.status === 'offline') {
            showErrorSheet(t('ticketScan.errors.noConnectionTitle'), result.message || t('ticketScan.errors.networkError'), 'cloud-off-outline');
            return;
          }
        ...
        showErrorSheet(t('ticketScan.errors.somethingWentWrongTitle'), t('ticketScan.errors.somethingWentWrongMessage'), 'alert-circle-outline');
      }
    },
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.overlayTop}>
          ...
          <View style={styles.instructionArea}>
            <Text variant="h2" style={styles.headerTitle}>{t('ticketScan.scanYourTicket')}</Text>
            <Text variant="caption" style={styles.headerSubtitle}>
              {t('ticketScan.positionTicket')}
            </Text>
          </View>
        </View>
