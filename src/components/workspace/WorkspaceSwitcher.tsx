...
export const WorkspaceSwitcher: React.FC<WorkspaceSwitcherProps> = ({
  ...
  const currentDisplay = useMemo(() => {
    ...
    return { initial: 'W', name: t('workspace.defaultName') };
  }, [current, user, t]);
  ...
  const confirmSwitch = useCallback(async () => {
    ...
    try {
      ...
      const msg = err?.response?.data?.message || err?.message || t('workspace.switchFailed');
      setSwitchError(msg);
    }
...
const WorkspaceListSheet: React.FC<WorkspaceListSheetProps> = ({
  ...
  return (
    <BottomSheet
      ...
      subtitle={t('workspace.chooseEnvironment')}
