...
export const AlertModal: React.FC<AlertModalProps> = ({
  ...
  const resolvedButtons = buttons ?? [{ text: t('common.ok'), style: 'default' as const }];
          ...
          <TouchableWithoutFeedback>
            <View style={[styles.container, { backgroundColor: theme.colors.card }]}>
              ...
              <View style={[
                ...
                resolvedButtons.length > 1 && styles.buttonRow,
              ]}>
                {resolvedButtons.map((button, index) => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.button,
                        resolvedButtons.length > 1 && styles.buttonHalf,
                        {
