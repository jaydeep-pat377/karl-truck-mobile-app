...
const statusI18nKeys: Record<OrderStatusFilter, string> = {
  all: 'orderTabs.all',
  saved: 'orderTabs.saved',
  scheduled: 'orderTabs.scheduled',
  active: 'orderTabs.active',
  completed: 'orderTabs.completed',
  cancelled: 'orderTabs.cancelled',
  requested: 'orderTabs.requested',
};
const statusOptions: { key: OrderStatusFilter }[] = [
  { key: 'all' },
  { key: 'saved' },
  { key: 'scheduled' },
  { key: 'active' },
        ...
        {statusOptions.map((option) => {
          ...
          return (
            ...
            >
              ...
              >
                {t(statusI18nKeys[option.key])} ({count})
              </Text>
            </TouchableOpacity>
          );
        })}
