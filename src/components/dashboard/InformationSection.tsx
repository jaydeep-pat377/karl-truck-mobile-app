          ...
          >
            ...
            <View style={styles.statsGrid}>
              <View style={styles.statItem}>
                ...
                <Text style={[styles.statLabel, { color: themeColors.text.hint }]}>{t('dashboard.statsDone')}</Text>
              </View>
              <View style={styles.statItem}>
                <Text style={[styles.statValue, { color: colors.dashboard.statYellow }]}>
                  {todayStats?.inProgress ?? 0}
                </Text>
                <Text style={[styles.statLabel, { color: themeColors.text.hint }]}>{t('dashboard.statsActive')}</Text>
              </View>
              <View style={styles.statItem}>
                <Text style={[styles.statValue, { color: colors.dashboard.statRed }]}>
                  {todayStats?.cancelled ?? 0}
                </Text>
                <Text style={[styles.statLabel, { color: themeColors.text.hint }]}>{t('dashboard.statsCancel')}</Text>
              </View>
            </View>
          </TouchableOpacity>
        )}
            ...
            {messages.length > maxVisible && onSeeAllPress && (
              <TouchableOpacity onPress={onSeeAllPress} activeOpacity={0.7}>
                <Text style={[styles.seeAllText, { color: colors.primary.main }]}>
                  {t('dashboard.seeAllCount', { count: messages.length })}
                </Text>
              </TouchableOpacity>
            )}
          </View>
