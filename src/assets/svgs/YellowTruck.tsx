...
interface YellowTruckProps {
  width?: number;
  height?: number;
}

const YellowTruck: React.FC<YellowTruckProps> = ({ width = 157, height = 86 }) => {
  return (
    <Svg width={width} height={height} viewBox="0 0 157 86" fill="none">
      <G>
        <Rect x="10" y="25" width="85" height="40" rx="4" fill={colors.warning.main} />
        <Rect x="12" y="27" width="81" height="36" rx="3" fill={colors.warning.light} />
        <Rect x="18" y="32" width="20" height="26" rx="2" fill={colors.warning.main} />
        <Rect x="42" y="32" width="20" height="26" rx="2" fill={colors.warning.main} />
        <Rect x="66" y="32" width="20" height="26" rx="2" fill={colors.warning.main} />
        <Path
